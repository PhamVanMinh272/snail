var spec = {
  ...
  "servers" : [ {
    "url" : "https://knri0h4ig4.execute-api.us-west-2.amazonaws.com/{basePath}",
    "variables" : {
      "basePath" : {
        "default" : "Stage"
      }
...
//var spec = require("./fison-Stage-oas30.json");
//import data from "./fison-Stage-oas30.json" assert { type: "json" };
//console.log(data);
//var spec = data;
//export default spec;
